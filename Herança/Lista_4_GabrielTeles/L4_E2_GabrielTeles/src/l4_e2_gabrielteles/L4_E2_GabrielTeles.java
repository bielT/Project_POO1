...
public class L4_E2_GabrielTeles {
    ...
    public static void main(String[] args) {
        Pessoa p = new Pessoa();
        //Pessoa p1 = new Pessoa(p.input.next(), p.input.next(), p.input.next());
        //Pessoa p2 = new Fornecedor(p.input.next(), p.input.next(), p.input.next(), p.input.nextFloat(), p.input.nextFloat());
        Pessoa p3 = new Empregado(p.input.next(), p.input.next(), p.input.next(), p.input.nextInt(), p.input.nextFloat(), p.input.nextFloat());
        //p1.status();
        //p2.status();
        //p2.obterSaldo();
        p3.status();
